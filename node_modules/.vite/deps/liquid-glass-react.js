...
var ShaderDisplacementGenerator = class {
  constructor(options) {
...
var GlassFilter = ({
  ...
  mode,
  shaderMapUrl
}) => (0, import_jsx_runtime.jsx)("svg", { style: { position: "absolute", width, height }, "aria-hidden": "true", children: (0, import_jsx_runtime.jsxs)("defs", { children: [
  (0, import_jsx_runtime.jsxs)("radialGradient", { id: `${id}-edge-mask`, cx: "50%", cy: "50%", r: "50%", children: [
    (0, import_jsx_runtime.jsx)("stop", { offset: "0%", stopColor: "black", stopOpacity: "0" }),
    (0, import_jsx_runtime.jsx)("stop", { offset: `${Math.max(30, 80 - aberrationIntensity * 2)}%`, stopColor: "black", stopOpacity: "0" }),
    (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: "white", stopOpacity: "1" })
  ] }),
  (0, import_jsx_runtime.jsxs)("filter", { id, x: "-35%", y: "-35%", width: "170%", height: "170%", colorInterpolationFilters: "sRGB", children: [
    (0, import_jsx_runtime.jsx)("feImage", { id: "feimage", x: "0", y: "0", width: "100%", height: "100%", result: "DISPLACEMENT_MAP", href: getMap(mode, shaderMapUrl), preserveAspectRatio: "xMidYMid slice" }),
    ...
    (0, import_jsx_runtime.jsx)("feComponentTransfer", { in: "EDGE_INTENSITY", result: "EDGE_MASK", children: (0, import_jsx_runtime.jsx)("feFuncA", { type: "discrete", tableValues: `0 ${aberrationIntensity * 0.05} 1` }) }),
    (0, import_jsx_runtime.jsx)("feOffset", { in: "SourceGraphic", dx: "0", dy: "0", result: "CENTER_ORIGINAL" }),
    (0, import_jsx_runtime.jsx)("feDisplacementMap", { in: "SourceGraphic", in2: "DISPLACEMENT_MAP", scale: displacementScale * (mode === "shader" ? 1 : -1), xChannelSelector: "R", yChannelSelector: "B", result: "RED_DISPLACED" }),
    (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "RED_DISPLACED",
    ...
    (0, import_jsx_runtime.jsx)("feDisplacementMap", { in: "SourceGraphic", in2: "DISPLACEMENT_MAP", scale: displacementScale * ((mode === "shader" ? 1 : -1) - aberrationIntensity * 0.05), xChannelSelector: "R", yChannelSelector: "B", result: "GREEN_DISPLACED" }),
    (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "GREEN_DISPLACED",
    ...
    (0, import_jsx_runtime.jsx)("feDisplacementMap", { in: "SourceGraphic", in2: "DISPLACEMENT_MAP", scale: displacementScale * ((mode === "shader" ? 1 : -1) - aberrationIntensity * 0.1), xChannelSelector: "R", yChannelSelector: "B", result: "BLUE_DISPLACED" }),
    (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "BLUE_DISPLACED",
    ...
    (0, import_jsx_runtime.jsx)("feBlend", { in: "GREEN_CHANNEL", in2: "BLUE_CHANNEL", mode: "screen", result: "GB_COMBINED" }),
    (0, import_jsx_runtime.jsx)("feBlend", { in: "RED_CHANNEL", in2: "GB_COMBINED", mode: "screen", result: "RGB_COMBINED" }),
    (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "RGB_COMBINED", stdDeviation: Math.max(0.1, 0.5 - aberrationIntensity * 0.1), result: "ABERRATED_BLURRED" }),
    (0, import_jsx_runtime.jsx)("feComposite", { in: "ABERRATED_BLURRED", in2: "EDGE_MASK", operator: "in", result: "EDGE_ABERRATION" }),
    (0, import_jsx_runtime.jsx)("feComponentTransfer", { in: "EDGE_MASK", result: "INVERTED_MASK", children: (0, import_jsx_runtime.jsx)("feFuncA", { type: "table", tableValues: "1 0" }) }),
    (0, import_jsx_runtime.jsx)("feComposite", { in: "CENTER_ORIGINAL", in2: "INVERTED_MASK", operator: "in", result: "CENTER_CLEAN" }),
    (0, import_jsx_runtime.jsx)("feComposite", { in: "EDGE_ABERRATION", in2: "CENTER_CLEAN", operator: "over" })
  ] })
] }) });
var GlassContainer = (0, import_react.forwardRef)(
  ({
    children,
    className = "",
    style,
    ...
    const [shaderMapUrl, setShaderMapUrl] = (0, import_react.useState)("");
    ...
    return (0, import_jsx_runtime.jsxs)("div", { ref, className: `relative ${className} ${active ? "active" : ""} ${Boolean(onClick) ? "cursor-pointer" : ""}`, style, onClick, children: [
      (0, import_jsx_runtime.jsx)(GlassFilter, { mode, id: filterId, displacementScale, aberrationIntensity, width: glassSize.width, height: glassSize.height, shaderMapUrl }),
...
function LiquidGlass({
  ...
  const [glassSize, setGlassSize] = (0, import_react.useState)({ width: 270, height: 69 });
  const [internalGlobalMousePos, setInternalGlobalMousePos] = (0, import_react.useState)({ x: 0, y: 0 });
  const [internalMouseOffset, setInternalMouseOffset] = (0, import_react.useState)({ x: 0, y: 0 });
  ...
  const handleMouseMove = (0, import_react.useCallback)(
    (e) => {
      const container = (mouseContainer == null ? void 0 : mouseContainer.current) || glassRef.current;
      if (!container) {
        return;
      }
  ...
  const calculateDirectionalScale = (0, import_react.useCallback)(() => {
  ...
  const calculateFadeInFactor = (0, import_react.useCallback)(() => {
    if (!globalMousePos.x || !globalMousePos.y || !glassRef.current) {
      return 0;
    }
    const rect = glassRef.current.getBoundingClientRect();
  ...
  const calculateElasticTranslation = (0, import_react.useCallback)(() => {
    if (!glassRef.current) {
      return { x: 0, y: 0 };
    }
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsx)(
      "span",
      {
        style: {
          ...
          rgba(255, 255, 255, ${0.12 + Math.abs(mouseOffset.x) * 8e-3}) ${Math.max(10, 33 + mouseOffset.y * 0.3)}%,
    ...
    (0, import_jsx_runtime.jsx)(
      "span",
      {
        style: {
          ...
          ${135 + mouseOffset.x * 1.2}deg,
          rgba(255, 255, 255, 0.0) 0%,
          rgba(255, 255, 255, ${0.32 + Math.abs(mouseOffset.x) * 8e-3}) ${Math.max(10, 33 + mouseOffset.y * 0.3)}%,
    ...
    Boolean(onClick) && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      (0, import_jsx_runtime.jsx)(
        "div",
        {
          style: {
...
//# sourceMappingURL=liquid-glass-react.js.map
